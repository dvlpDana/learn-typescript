...
//타입 모듈
import { CovidSummaryResponse, CovidSummaryResponses } from "./covid/index";
// utils
...
// DOM
// const a: Element | HTMLElement | HTMLParagraphElement
...
function fetchCountryInfo(
  countryCode: string,
  status: CovidStatus
): Promise<AxiosResponse<CovidSummaryResponses>> {
